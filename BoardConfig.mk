...
BOARD_KERNEL_CMDLINE :=  mem=448M@0M nvmem=64M@448M vmalloc=192M video=tegrafb console=ttyS0,115200n8 usbcore.old_scheme_first=1 cpuid=200102 devicetype=1002 btmac=737b8c131a00 tegraboot=nand mtdparts=tegra_nand:16384K@7424K(misc),16384K@24320K(recovery),16384K@41216K(boot),204800K@58112K(system),260224K@263552K(cache)
